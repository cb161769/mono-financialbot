...
namespace mono_financialbot_backend_cs_datalayer.Core.Interfaces
{
    /// <summary>
    ...
    public interface IBaseRepository<TInputModel, TEditModel, TDtoModel>
        ...
        where TEditModel : BaseEditModel
    {
        ...
        Task<PaginationResult<TDtoModel>> GetPaginatedList(PaginationModel paginate,
        ...
        Task<IEnumerable<TDtoModel>> GetList(Expression<Func<TDtoModel, bool>>? expression = null,
               bool orderDesc = true,
            Expression<Func<TDtoModel, object>>? ordered = null,
            CancellationToken cancellationToken = default,
            params Expression<Func<TDtoModel, object>>[] includes);
        ...
        IQueryable<TDtoModel> GetAll(Expression<Func<TDtoModel, bool>>? expression = null,
            bool orderDesc = true,
            Expression<Func<TDtoModel, object>>? ordered = null,
            params Expression<Func<TDtoModel, object>>[] includes);
        ...
        /// <param name="cancellationToken">cancellationToken</param>
        /// <returns>bool</returns>
        Task<bool> Exist(Expression<Func<TDtoModel, bool>> expression, CancellationToken cancellationToken = default);
